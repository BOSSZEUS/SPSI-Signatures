  ...
  <tr>
    <td colspan="2" style="padding: 5px 0 0 0; text-align: left; border-top: 1px solid #ccc;">
      <div style="margin: 10px 0; font-size: 14px; color: #333;">
        <p style="margin: 0; font-weight: bold; font-size: 16px; color:red;"><strong>SPSI Closure Notice.</strong></p>
        <p style="margin: 5px 0; color: black;"><strong>Our Minnesota and Texas offices will be closed for order processing and shipping from Tuesday, December 30 through Friday, January 2 for our ERP system conversion. </strong></p>
        <p style="margin: 5px 0; color: black;"><strong>During this time, please visit our website to place orders: <a href="https://spsi.com">SPSI.com</a>. </strong></p>
        <p style="margin: 5px 0; color: black;"><strong>Shipping Will resume on Monday, January 5.</strong></p>  
    </td>
  </tr>
