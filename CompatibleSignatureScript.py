  ...
  <tr>
    <td colspan="2" style="padding: 5px 0 0 0; text-align: left; border-top: 1px solid #ccc;">
      <div style="margin: 10px 0; font-size: 14px; color: #333;">
        <p style="margin: 0; font-weight: bold; font-size: 16px; color:red;">SPSI Closure Notice.</p>
        <p style="margin: 5px 0; color: black;">Our Minnesota and Texas offices will be closed for order processing and shipping from Wednesday, November 26 through Monday, December 1 for our ERP system conversion. During this time, please visit our website to place orders <a href="https://spsi.com">SPSI.com</a>. </p>
      </div>
    </td>
  </tr>
